const ko = {
  ...
  "year.account": "항목",
  "year.line": "구분",
  "year.monthNumber": "{n}월",
  "year.total": "합계",
  "year.sum": "합계",
  "year.saving": "저축가능액",
  "year.cumulative": "누적",
  "year.monthRate": "월 계획 대비",
  "year.yearRate": "연 계획 대비",
  "year.empty": "이 해에는 수입도 지출도 없습니다.",
  "year.hint":
    "지나간 달은 장부의 실적, 이번 달부터는 예산입니다 — 연한 숫자가 예산 쪽. 금액은 만·억 단위로 줄여 적었고, 이 해의 저축가능액 합계는 {total}입니다. 「월 계획 대비」는 끝난 달만 나옵니다 — 아직 예산대로인 달은 계획과 같은 값이라 늘 100%일 테니까요. 「연 계획 대비」의 색은 100%가 아니라 그 달까지 흘러간 만큼(1월이면 1/12)과 견준 것입니다.",
