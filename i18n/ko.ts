const ko = {
  ...
  "csv.importPeriodBudgets": "기간별 예산 CSV 가져오기",
  "csv.periodBudgetsHint":
    "다른 가계부에서 뽑은 「시작일,종료일,계정,항목,예산,금액,잔여액」 형식의 예산표를 그대로 올리면 됩니다. 예산 열만 읽고, 지출액과 잔여액은 이 앱이 거래에서 직접 계산하므로 무시합니다. 합계 줄과 상위 그룹 줄은 넣을 곳이 없어 건너뛰며, 어떤 줄을 건너뛰었는지 미리보기에서 확인할 수 있습니다.",
